...
public class UpdateComputerDTOToComputer implements Function<UpdateComputerDTO, Computer> {
    ...
    public UpdateComputerDTOToComputer(LongFunction<Company> findCompanyById) {
	super();
