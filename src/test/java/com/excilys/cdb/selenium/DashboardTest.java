...
public class DashboardTest {
    ...
    private void checkComputers(int size, long firstID, long lastID) {
        ...
        assertEquals(ITDatabase.getInstance().findComputerById(firstID), computersTableLines.get(0));
        assertEquals(ITDatabase.getInstance().findComputerById(lastID), computersTableLines.get(computersTableLines.size() - 1));
    }
    ...
    public void testSearch() {
        ...
        checkComputers(PAGE_SIZE_10, FIRST_ID_PAGE_1_SIZE_10_APPLE_BY_NAME_ASC, LAST_ID_PAGE_1_SIZE_10_APPLE_BY_NAME_ASC);

        // next page 2 size 10
        clickPaginationButton(NEXT);
        assertCount(count);
        checkPagination(PREVIOUS, "1", "2", "3", "4", "5", NEXT);
        checkComputers(PAGE_SIZE_10, FIRST_ID_PAGE_2_SIZE_10_APPLE_BY_NAME_ASC, LAST_ID_PAGE_2_SIZE_10_APPLE_BY_NAME_ASC);

        // go to page 5
        clickPaginationButton("5");
        assertCount(count);
        checkPagination(PREVIOUS, "1", "2", "3", "4", "5");
        checkComputers(PAGE_SIZE_10, FIRST_ID_PAGE_5_SIZE_10_APPLE_BY_NAME_ASC, LAST_ID_PAGE_5_SIZE_10_APPLE_BY_NAME_ASC);
    }
