...
public class UpdateComputerDTO {
    ...
    public static class UpdateComputerDTOBuilder {
        ...
        public String toString() {
            return "UpdateComputerDTO.UpdateComputerDTOBuilder(id=" + this.id + ", discontinued=" + this.discontinued + ", introduced=" + this.introduced + ", mannufacturerId=" + this.mannufacturerId + ", name=" + this.name + ")";
        }
    }
}
