...
public class ComputerDTO {
    ...
    public static class ComputerDTOBuilder {
        ...
        public String toString() {
            return "ComputerDTO.ComputerDTOBuilder(discontinued=" + this.discontinued + ", id=" + this.id + ", introduced=" + this.introduced + ", mannufacturer=" + this.mannufacturer + ", name=" + this.name + ")";
        }
    }
}
