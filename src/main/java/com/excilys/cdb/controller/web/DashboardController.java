...
public class DashboardController {
    ...
    public DashboardController(Pagination pagination, Sorting sorting, ComputerService computerService, ComputerToComputerDTOMapper computerToComputerDTOMapper) {
    ...
    @PostMapping
    public String deleteComputer(@RequestParam("selection") List<Long> removeComputersId, @RequestParam(required = false) String search, @RequestParam(name = "order-by", defaultValue = "name") OrderBy.Field field, @RequestParam(defaultValue = "asc") OrderBy.Meaning meaning, @RequestParam(name = "page", defaultValue = "1") long index, @RequestParam(defaultValue = "50") long size) throws UnsupportedEncodingException {
    ...
    @GetMapping
    public ModelAndView computers(@RequestParam(required = false) String search, @RequestParam(name = "order-by", defaultValue = "name") OrderBy.Field field, @RequestParam(defaultValue = "asc") OrderBy.Meaning meaning, @RequestParam(name = "page", defaultValue = "1") long index, @RequestParam(defaultValue = "50") long size) throws UnsupportedEncodingException {
