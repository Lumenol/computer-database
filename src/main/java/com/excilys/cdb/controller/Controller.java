...
public class Controller {
    ...
    public Controller(CompanyService companyService, Mapper<Company, CompanyDTO> companyToCompanyDTO, ComputerService computerService, Mapper<Computer, ComputerDTO> computerToComputerDTO, CreateComputerDTOToComputerMapper createComputerDTOToComputerMapper, CreateComputerValidator createComputerValidator, UpdateComputerDTOToComputerMapper updateComputerDTOToComputerMapper, UpdateComputerValidator updateComputerValidator) {
