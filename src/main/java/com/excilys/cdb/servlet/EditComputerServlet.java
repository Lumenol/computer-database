...
public class EditComputerServlet extends HttpServlet {
    ...
    private final UpdateComputerDTOToComputerMapper updateComputerDTOToComputerMapper = WebApplicationContextUtils.getRequiredWebApplicationContext(getServletContext()).getBean(UpdateComputerDTOToComputerMapper.class);
    private final UpdateComputerValidator updateComputerValidator = WebApplicationContextUtils.getRequiredWebApplicationContext(getServletContext()).getBean(UpdateComputerValidator.class);
