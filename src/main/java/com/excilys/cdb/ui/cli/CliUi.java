...
public class CliUi implements Ui {
    ...
    @Override
    public com.excilys.cdb.ui.dto.UpdateComputerDTO getUpdateComputerDTO() {
	com.excilys.cdb.ui.dto.UpdateComputerDTO dto = new com.excilys.cdb.ui.dto.UpdateComputerDTO();
