...
public class CompanyService {
    ...
    public CompanyService(CompanyDAO companyDAO, ConnectionManager instance, ComputerDAO computerDAO) {
    ...
    public void delete(long id) {
        try (final Transaction transaction = instance.getTransaction()) {
