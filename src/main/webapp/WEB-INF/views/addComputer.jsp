				...
				<div class="col-xs-8 col-xs-offset-2 box">
					...
					<c:if test="${(not empty success) && success}">
						<div class="alert alert-success" role="alert">
							<strong><spring:message code="form.success"/></strong> <spring:message code="addComputer.success"/></div>
					</c:if>
					<c:if test="${(not empty success) && !success}">
						<div class="alert alert-danger" role="alert">
							<strong><spring:message code="form.faillure"/></strong> <spring:message code="addComputer.faillure"/></div>
					</c:if>
					...
					<form:form action="add" method="POST" modelAttribute="computer">
						<fieldset>
							...
							<spring:bind path="mannufacturerId">
								<div class='form-group'>
									<form:label path="mannufacturerId"><spring:message code="computer.mannufacturer"/></form:label>
